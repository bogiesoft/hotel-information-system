...
/**
 * This is the model base class for the table "m_customer".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "MCustomer".
 *
 * Columns in table "m_customer" available as properties of the model,
 ...
 *
 */
abstract class BaseMCustomer extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'MCustomer|MCustomers', $n);
	}
