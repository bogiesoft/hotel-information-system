...
class PHPExtJSCrudCode extends CCodeModel {
    ...
    public function prepare() {
        ...
        //Create ExtJS MVC Store file

        $this->files[] = new CCodeFile(
                Yii::getPathOfAlias('webroot' . '.' )."/../hotel-app/app/model/".$this->modelClass . '.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/model/model.php')
        );

        $this->files[] = new CCodeFile(
                Yii::getPathOfAlias('webroot' . '.' )."/../hotel-app/app/view/content/".$this->controller . '/Controller.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/controller/controller.php')
        );

        $this->files[] = new CCodeFile(
                Yii::getPathOfAlias('webroot' . '.' )."/../hotel-app/app/store/".$this->modelClass . 's.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/store/store.php')
        );
        
        $this->files[] = new CCodeFile(
                Yii::getPathOfAlias('webroot' . '.' )."/../hotel-app/app/view/content/".$this->controller . '/Form.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/view/form.php')
        );
        $this->files[] = new CCodeFile(
                Yii::getPathOfAlias('webroot' . '.' )."/../hotel-app/app/view/content/".$this->controller . '/Index.js', $this->render($templatePath . DIRECTORY_SEPARATOR . 'app/view/grid.php')
        );
    }
